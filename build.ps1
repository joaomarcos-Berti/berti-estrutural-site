...
<style>
  ...
  .mp__it{ min-height:86px; }
  .mp__it img{ flex:0 0 100px; align-self:stretch; min-height:86px; object-fit:cover; background:#dfe6ec; }
  ...
  <section class="sec e3" id="estrutura-3d">
    <div style="max-width:1200px;margin:0 auto">
      ...
      <div class="e3stage">
        ...
        <svg class="e3arrow" width="104" height="78" viewBox="0 0 132 98" fill="none" style="left:214px;top:172px"><path d="M6 10 C50 22 80 44 114 80" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round"/><path d="M114 80 L94 78 M114 80 L110 58" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        ...
        <svg class="e3arrow" width="104" height="78" viewBox="0 0 132 98" fill="none" style="right:196px;bottom:150px"><path d="M126 88 C82 76 52 54 18 18" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round"/><path d="M18 18 L38 20 M18 18 L22 40" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
        ...
        <svg class="e3arrow" width="104" height="78" viewBox="0 0 132 98" fill="none" style="left:196px;bottom:150px"><path d="M6 88 C50 76 80 54 114 18" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round"/><path d="M114 18 L94 20 M114 18 L110 40" stroke="#47b6f1" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
