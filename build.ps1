...
<header class="nav" id="nav">
  <a class="nav__logo" href="/"><img src="/assets/logo-be-mark.png" alt="Berti Estrutural" /></a>
...
<style>
  ...
  /* ESTRUTURA 3D */
  .e3{ background:#fff; }
  .e3 model-viewer{ width:100%; height:560px; background:transparent; --poster-color:transparent; }
  .e3__adv{ display:grid; grid-template-columns:repeat(3,1fr); gap:24px; margin-top:24px; }
  ...
  .mp__it img{ flex:0 0 100px; height:84px; object-fit:cover; background:#dfe6ec; }
  ...
  .ct__s{ display:flex; flex-direction:column; align-items:center; text-decoration:none; color:inherit; }
  .ct__n{ width:72px; height:72px; border-radius:50%; border:2px solid #c6d4e2; background:#fff; display:flex; align-items:center; justify-content:center; font-family:'Caveat',cursive; font-weight:700; font-size:26px; color:#1853b8; margin-bottom:16px; }
  .ct__s:hover .ct__n{ background:#077fbf; color:#fff; border-color:#077fbf; }
  ...
  .ct__b{ font-size:14px; line-height:1.55; color:#4a606e; max-width:210px; }
  /* CATEGORIAS */
  ...
  .cg__img img{ width:100%; height:100%; object-fit:cover; transition:transform 700ms ease; }
  .cg__c:hover .cg__img img{ transform:scale(1.06); }
  ...
  @media(max-width:980px){
    .e3__adv{ grid-template-columns:1fr; } .e3 model-viewer{ display:none; } .e3__note{ display:block; text-align:center; margin-top:18px; padding:13px 14px; border:1.5px solid rgba(7,127,191,0.4); border-radius:8px; color:var(--blue-dark); font-family:'Barlow Condensed',sans-serif; font-weight:700; font-size:12.5px; letter-spacing:0.06em; text-transform:uppercase; }
    ...
    .ct__grid{ grid-template-columns:repeat(2,1fr); gap:32px 20px; }
...
<main>
  ...
  <section class="sec e3" id="estrutura-3d">
    <div style="max-width:1200px;margin:0 auto">
      ...
      <model-viewer src="/assets/3d/palladium.glb" alt="Estrutura metálica Palladium — Berti Estrutural" camera-controls auto-rotate auto-rotate-delay="0" rotation-per-second="18deg" interaction-prompt="none" field-of-view="30deg" camera-orbit="35deg 75deg 72%" shadow-intensity="0.6" exposure="1.15" tone-mapping="neutral" environment-image="legacy" loading="lazy"></model-viewer>
      <div class="e3__adv">
  ...
  <section class="sec ct">
    ...
    <div class="ct__grid">
      <a class="ct__s" href="/empresa"><div class="ct__n">01</div><div class="ct__w">Avaliação</div><div class="ct__t">Avaliação &amp; Recebimento</div><div class="ct__b">O cliente encaminha a proposta e nossa equipe avalia se o projeto se enquadra nos padrões Berti.</div></a>
      <a class="ct__s" href="/empresa"><div class="ct__n">02</div><div class="ct__w">Orçamento</div><div class="ct__t">Estudo Técnico &amp; Orçamento</div><div class="ct__b">Modelo inicial em realidade virtual com valores, materiais e soluções para redução de custos.</div></a>
      <a class="ct__s" href="/empresa"><div class="ct__n">03</div><div class="ct__w">BIM</div><div class="ct__t">Cálculo &amp; Modelagem BIM</div><div class="ct__b">Softwares avançados calculam e modelam cada peça — listas de fabricação para encaixe perfeito.</div></a>
      <a class="ct__s" href="/empresa"><div class="ct__n">04</div><div class="ct__w">Fabricação</div><div class="ct__t">Melhores Fábricas</div><div class="ct__b">Principais fábricas de aço do país — estrutura e cobertura com qualidade e rastreabilidade.</div></a>
      <a class="ct__s" href="/empresa"><div class="ct__n">05</div><div class="ct__w">Montagem</div><div class="ct__t">Montagem 100% Parafusada</div><div class="ct__b">Peças montadas como um quebra-cabeça — sem solda em campo, com precisão e agilidade.</div></a>
    </div>
  ...
  <section class="sec cg" id="obras">
    ...
    <div class="cg__grid">
      <a class="cg__c" href="/obras"><div class="cg__img"><img src="/assets/portfolio/supermercado-1.webp" alt="Supermercados em estrutura metálica" loading="lazy" /><div class="cg__sh"></div><div class="cg__num">01</div><div class="cg__ti">Supermercados</div></div><div class="cg__bd"><p>Coberturas de grande vão livre, mezaninos e estruturas para varejo de alto fluxo. Obra rápida, com a loja já operando.</p><div class="cg__go"><b>Ver obras</b><i>&rarr;</i></div></div></a>
      <a class="cg__c" href="/obras"><div class="cg__img"><img src="/assets/portfolio/comercial-1.webp" alt="Obras comerciais em estrutura metálica" loading="lazy" /><div class="cg__sh"></div><div class="cg__num">02</div><div class="cg__ti">Comercial</div></div><div class="cg__bd"><p>Showrooms, concessionárias, lojas de materiais e centros logísticos urbanos. Pé-direito generoso e fachada limpa.</p><div class="cg__go"><b>Ver obras</b><i>&rarr;</i></div></div></a>
      <a class="cg__c" href="/obras"><div class="cg__img"><img src="/assets/portfolio/industrial-1.webp" alt="Obras industriais em estrutura metálica" loading="lazy" /><div class="cg__sh"></div><div class="cg__num">03</div><div class="cg__ti">Industrial</div></div><div class="cg__bd"><p>Galpões fabris, plantas industriais e pavilhões logísticos de grande porte. Engenharia para cargas pesadas e operação 24/7.</p><div class="cg__go"><b>Ver obras</b><i>&rarr;</i></div></div></a>
    </div>
